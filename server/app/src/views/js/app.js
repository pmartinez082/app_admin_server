...
export async function login() {
  ...
  authForm.password.setAttribute('required', '');
  authForm.password.setAttribute('minlength', '4');
  authForm.password.setAttribute('maxlength', '20');
  authForm.email?.setAttribute('type', 'email');
  ...
  const info = `<div class="button-container">
        ...
        <form id="adminForm1" action="../berria">
            <button class="button-berria2" title="Berria gehitu">
              <svg style="fill:none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="icon">
        ...
        <form id="adminForm3" action="../faseak">
            <div class="btn-cont">
              <button class="button">
                <svg class="settings-btn" xmlns="http://www.w3.org/2000/svg" height="35" viewBox="0 -960 960 960" width="35">
                  <path d="${d}"></path>
                </svg>
        ...
        <form id="adminForm5" action="../profila">
            <button class="button-berria2" title="Epaimahaikidea gehitu">
              <img src="../pics/profila.svg" alt="Porfila ikusi">
            </button>
        </form>
    </div>`;
